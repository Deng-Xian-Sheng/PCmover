...
namespace System.IO
{
	...
	{
		// Token: 0x06001940 RID: 6464 RVA: 0x00053EEC File Offset: 0x000520EC
		...
		// Token: 0x06001941 RID: 6465 RVA: 0x00053F80 File Offset: 0x00052180
		...
		// Token: 0x06001942 RID: 6466 RVA: 0x00053FF6 File Offset: 0x000521F6
		internal static bool IsValidDriveChar(char value)
		{
			return (value >= 'A' && value <= 'Z') || (value >= 'a' && value <= 'z');
		}

		// Token: 0x06001943 RID: 6467 RVA: 0x00054013 File Offset: 0x00052213
		...
		// Token: 0x06001944 RID: 6468 RVA: 0x0005404C File Offset: 0x0005224C
		...
		// Token: 0x06001945 RID: 6469 RVA: 0x00054099 File Offset: 0x00052299
		...
		// Token: 0x06001946 RID: 6470 RVA: 0x000540C8 File Offset: 0x000522C8
		...
		// Token: 0x06001947 RID: 6471 RVA: 0x00054102 File Offset: 0x00052302
		...
		// Token: 0x06001948 RID: 6472 RVA: 0x00054126 File Offset: 0x00052326
		...
		// Token: 0x06001949 RID: 6473 RVA: 0x0005414C File Offset: 0x0005234C
		...
		// Token: 0x0600194A RID: 6474 RVA: 0x000541AC File Offset: 0x000523AC
		...
		// Token: 0x0600194B RID: 6475 RVA: 0x0005420C File Offset: 0x0005240C
		internal static bool IsExtended(string path)
		{
			return path.Length >= 4 && path[0] == '\\' && (path[1] == '\\' || path[1] == '?') && path[2] == '?' && path[3] == '\\';
		}

		// Token: 0x0600194C RID: 6476 RVA: 0x0005425C File Offset: 0x0005245C
		internal static bool IsExtended(StringBuilder path)
		{
			return path.Length >= 4 && path[0] == '\\' && (path[1] == '\\' || path[1] == '?') && path[2] == '?' && path[3] == '\\';
		}

		// Token: 0x0600194D RID: 6477 RVA: 0x000542AC File Offset: 0x000524AC
		internal static bool IsExtended(StringBuffer path)
		{
			return path.Length >= 4U && path[0U] == '\\' && (path[1U] == '\\' || path[1U] == '?') && path[2U] == '?' && path[3U] == '\\';
		}

		// Token: 0x0600194E RID: 6478 RVA: 0x000542FC File Offset: 0x000524FC
		...
		// Token: 0x0600194F RID: 6479 RVA: 0x00054360 File Offset: 0x00052560
		internal static bool IsExtendedUnc(StringBuilder path)
		{
			return path.Length >= "\\\\?\\UNC\\".Length && PathInternal.IsExtended(path) && char.ToUpper(path[4]) == 'U' && char.ToUpper(path[5]) == 'N' && char.ToUpper(path[6]) == 'C' && path[7] == '\\';
		}

		// Token: 0x06001950 RID: 6480 RVA: 0x000543C4 File Offset: 0x000525C4
		...
		// Token: 0x06001951 RID: 6481 RVA: 0x000543DE File Offset: 0x000525DE
		...
		// Token: 0x06001952 RID: 6482 RVA: 0x000543FC File Offset: 0x000525FC
		...
		// Token: 0x06001953 RID: 6483 RVA: 0x00054430 File Offset: 0x00052630
		...
		// Token: 0x06001954 RID: 6484 RVA: 0x00054464 File Offset: 0x00052664
		...
		// Token: 0x06001955 RID: 6485 RVA: 0x0005448E File Offset: 0x0005268E
		[SecuritySafeCritical]
		...
		// Token: 0x06001956 RID: 6486 RVA: 0x000544AC File Offset: 0x000526AC
		[SecurityCritical]
		...
		// Token: 0x06001957 RID: 6487 RVA: 0x0005458C File Offset: 0x0005278C
		[SecurityCritical]
		...
		// Token: 0x06001958 RID: 6488 RVA: 0x000545CC File Offset: 0x000527CC
		...
		// Token: 0x06001959 RID: 6489 RVA: 0x00054648 File Offset: 0x00052848
		...
		// Token: 0x0600195A RID: 6490 RVA: 0x000546C4 File Offset: 0x000528C4
		...
		// Token: 0x0600195B RID: 6491 RVA: 0x00054734 File Offset: 0x00052934
		...
		// Token: 0x0600195C RID: 6492 RVA: 0x00054748 File Offset: 0x00052948
