...
namespace System
{
	...
	public abstract class Array : ICloneable, IList, ICollection, IEnumerable, IStructuralComparable, IStructuralEquatable
	{
		...
		{
			// Token: 0x06006995 RID: 27029 RVA: 0x0016B854 File Offset: 0x00169A54
			public FunctorComparer(Comparison<T> comparison)
			{
				this.comparison = comparison;
			}

			// Token: 0x06006996 RID: 27030 RVA: 0x0016B863 File Offset: 0x00169A63
		...
		{
			// Token: 0x06006997 RID: 27031 RVA: 0x0016B872 File Offset: 0x00169A72
			...
			// Token: 0x06006998 RID: 27032 RVA: 0x0016B894 File Offset: 0x00169A94
			...
			// Token: 0x06006999 RID: 27033 RVA: 0x0016B910 File Offset: 0x00169B10
			...
			// Token: 0x0600699A RID: 27034 RVA: 0x0016B969 File Offset: 0x00169B69
			...
			// Token: 0x0600699B RID: 27035 RVA: 0x0016B98C File Offset: 0x00169B8C
			...
			// Token: 0x0600699C RID: 27036 RVA: 0x0016BB70 File Offset: 0x00169D70
			...
			// Token: 0x0600699D RID: 27037 RVA: 0x0016BBDC File Offset: 0x00169DDC
			...
			// Token: 0x0600699E RID: 27038 RVA: 0x0016BC60 File Offset: 0x00169E60
			...
			// Token: 0x0600699F RID: 27039 RVA: 0x0016BCFC File Offset: 0x00169EFC
			...
			// Token: 0x060069A0 RID: 27040 RVA: 0x0016BD4C File Offset: 0x00169F4C
			...
			// Token: 0x060069A1 RID: 27041 RVA: 0x0016BE34 File Offset: 0x0016A034
		...
		{
			// Token: 0x060069A2 RID: 27042 RVA: 0x0016BEE1 File Offset: 0x0016A0E1
			...
			// Token: 0x060069A3 RID: 27043 RVA: 0x0016BF04 File Offset: 0x0016A104
			internal void SwapIfGreaterWithItems(int a, int b)
			{
			...
			// Token: 0x060069A4 RID: 27044 RVA: 0x0016BFAC File Offset: 0x0016A1AC
			private void Swap(int i, int j)
			{
			...
			// Token: 0x060069A5 RID: 27045 RVA: 0x0016C025 File Offset: 0x0016A225
			internal void Sort(int left, int length)
			{
				if (BinaryCompatibility.TargetsAtLeast_Desktop_V4_5)
				{
			...
			// Token: 0x060069A6 RID: 27046 RVA: 0x0016C048 File Offset: 0x0016A248
			private void DepthLimitedQuickSort(int left, int right, int depthLimit)
			{
				do
				{
			...
			// Token: 0x060069A7 RID: 27047 RVA: 0x0016C26C File Offset: 0x0016A46C
			private void IntrospectiveSort(int left, int length)
			{
				if (length < 2)
				{
			...
			// Token: 0x060069A8 RID: 27048 RVA: 0x0016C2DC File Offset: 0x0016A4DC
			private void IntroSort(int lo, int hi, int depthLimit)
			{
				while (hi > lo)
				{
			...
			// Token: 0x060069A9 RID: 27049 RVA: 0x0016C360 File Offset: 0x0016A560
			private int PickPivotAndPartition(int lo, int hi)
			{
				int num = lo + (hi - lo) / 2;
				this.SwapIfGreaterWithItems(lo, num);
			...
			// Token: 0x060069AA RID: 27050 RVA: 0x0016C408 File Offset: 0x0016A608
			private void Heapsort(int lo, int hi)
			{
				int num = hi - lo + 1;
				for (int i = num / 2; i >= 1; i--)
			...
			// Token: 0x060069AB RID: 27051 RVA: 0x0016C458 File Offset: 0x0016A658
			private void DownHeap(int i, int n, int lo)
			{
			...
			// Token: 0x060069AC RID: 27052 RVA: 0x0016C56C File Offset: 0x0016A76C
			private void InsertionSort(int lo, int hi)
			{
				for (int i = lo; i < hi; i++)
				{
		...
		{
			// Token: 0x060069AD RID: 27053 RVA: 0x0016C63D File Offset: 0x0016A83D
			...
			// Token: 0x060069AE RID: 27054 RVA: 0x0016C65F File Offset: 0x0016A85F
			public object Clone()
			{
				return base.MemberwiseClone();
			}

			// Token: 0x060069AF RID: 27055 RVA: 0x0016C667 File Offset: 0x0016A867
			...
			// (get) Token: 0x060069B0 RID: 27056 RVA: 0x0016C698 File Offset: 0x0016A898
			...
			// Token: 0x060069B1 RID: 27057 RVA: 0x0016C6ED File Offset: 0x0016A8ED
			public void Reset()
			{
				this._index = -1;
			}
		...
		{
			// Token: 0x060069B2 RID: 27058 RVA: 0x0016C6F8 File Offset: 0x0016A8F8
			...
			// Token: 0x060069B3 RID: 27059 RVA: 0x0016C78C File Offset: 0x0016A98C
			...
			// Token: 0x060069B4 RID: 27060 RVA: 0x0016C81A File Offset: 0x0016AA1A
			public object Clone()
			{
				return base.MemberwiseClone();
			}

			// Token: 0x060069B5 RID: 27061 RVA: 0x0016C822 File Offset: 0x0016AA22
			public bool MoveNext()
			{
				if (this._complete)
				{
			...
			// (get) Token: 0x060069B6 RID: 27062 RVA: 0x0016C858 File Offset: 0x0016AA58
			public object Current
			{
				get
				{
			...
			// Token: 0x060069B7 RID: 27063 RVA: 0x0016C8AC File Offset: 0x0016AAAC
			public void Reset()
			{
