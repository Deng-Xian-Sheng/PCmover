...
namespace System
{
	...
	{
		// Token: 0x060010E3 RID: 4323 RVA: 0x00032DE8 File Offset: 0x00030FE8
		...
		// Token: 0x060010E5 RID: 4325 RVA: 0x00032DF4 File Offset: 0x00030FF4
		[SecuritySafeCritical]
		public unsafe static long StringToLong(string s, int radix, int flags, ref int currPos)
		{
			...
			{
				int* currPos2 = ptr;
				return ParseNumbers.StringToLong(s, radix, flags, currPos2);
			}
		}

		// Token: 0x060010E6 RID: 4326 RVA: 0x00032E0F File Offset: 0x0003100F
		[SecuritySafeCritical]
		...
		// Token: 0x060010E8 RID: 4328 RVA: 0x00032E1C File Offset: 0x0003101C
		[SecuritySafeCritical]
		public unsafe static int StringToInt(string s, int radix, int flags, ref int currPos)
		{
			...
			{
				int* currPos2 = ptr;
				return ParseNumbers.StringToInt(s, radix, flags, currPos2);
			}
		}
