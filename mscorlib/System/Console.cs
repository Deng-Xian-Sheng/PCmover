...
namespace System
{
	...
	public static class Console
	{
		...
		public unsafe static void MoveBufferArea(int sourceLeft, int sourceTop, int sourceWidth, int sourceHeight, int targetLeft, int targetTop, char sourceChar, ConsoleColor sourceForeColor, ConsoleColor sourceBackColor)
		{
			...
			bool flag = Win32Native.ReadConsoleOutput(Console.ConsoleOutputHandle, pBuffer, dwSize, bufferCoord, ref small_RECT);
			array2 = null;
			if (!flag)
			{
				__Error.WinIOError();
			...
			flag = Win32Native.WriteConsoleOutput(Console.ConsoleOutputHandle, buffer, dwSize, bufferCoord, ref small_RECT2);
			array2 = null;
		}
		...
		{
			// Token: 0x060069E9 RID: 27113 RVA: 0x0016CD13 File Offset: 0x0016AF13
			[SecurityCritical]
			...
			// Token: 0x060069EA RID: 27114 RVA: 0x0016CD30 File Offset: 0x0016AF30
			~ControlCHooker()
			{
				this.Unhook();
			}

			// Token: 0x060069EB RID: 27115 RVA: 0x0016CD5C File Offset: 0x0016AF5C
			[SecuritySafeCritical]
			internal void Hook()
			{
				if (!this._hooked)
			...
			// Token: 0x060069EC RID: 27116 RVA: 0x0016CD90 File Offset: 0x0016AF90
			[SecuritySafeCritical]
		...
		{
			// Token: 0x060069ED RID: 27117 RVA: 0x0016CDC1 File Offset: 0x0016AFC1
