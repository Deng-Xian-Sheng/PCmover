...
namespace System
{
	...
	public struct ArraySegment<T> : IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable, IReadOnlyList<T>, IReadOnlyCollection<T>
	{
		...
		{
			// Token: 0x060069BF RID: 27071 RVA: 0x0016C9F0 File Offset: 0x0016ABF0
			...
			// Token: 0x060069C0 RID: 27072 RVA: 0x0016CA3C File Offset: 0x0016AC3C
			...
			// (get) Token: 0x060069C1 RID: 27073 RVA: 0x0016CA6C File Offset: 0x0016AC6C
			public T Current
			{
				get
				{
			...
			// (get) Token: 0x060069C2 RID: 27074 RVA: 0x0016CAC6 File Offset: 0x0016ACC6
			...
			// Token: 0x060069C3 RID: 27075 RVA: 0x0016CAD3 File Offset: 0x0016ACD3
			void IEnumerator.Reset()
			{
				this._current = this._start - 1;
			}

			// Token: 0x060069C4 RID: 27076 RVA: 0x0016CAE3 File Offset: 0x0016ACE3
			public void Dispose()
			{
			}
