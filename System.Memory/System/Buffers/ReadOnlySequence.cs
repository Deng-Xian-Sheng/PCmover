...
namespace System.Buffers
{
	...
	public readonly struct ReadOnlySequence<T>
	{
		...
		public ReadOnlySequence<T> Slice(long start)
		{
			...
			SequencePosition sequencePosition = this.Seek(this._sequenceStart, this._sequenceEnd, start, ExceptionArgument.start);
		...
		public SequencePosition GetPosition(long offset, SequencePosition origin)
		{
			...
			return this.Seek(origin, this._sequenceEnd, offset, ExceptionArgument.offset);
		}
